<b>Respected</b> <strong>{{$users->fullname}}</strong> 
<p>You are hereby informed that all the students have submitted their videos and all videos are available on the following link</p>
