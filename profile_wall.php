...
<section class="profile">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <div class="img_banner"><img src="../actor-pass/assets/images/profile_banner.png" class="img-responsive"></div>
         </div>
      </div>
   </div>
   <div class="container">
      <div class="col-md-3 border_left">
         <div class="vertical-menu">
            <div class="side_img"><img src="../actor-pass/assets/images/profile_img.png" class="img-responsive"></div>
            ...
            <div class="panel-body">
               <div class="tab-content">
                  <div class="tab-pane fade in active" id="tab1default">
                     <!--<div class="wall_img"><img src="../actor-pass/assets/images/wall_image.png" class="img-responsive"></div>-->
                     <div class="col-md-2">
                        <div class="wall_img"><img src="../actor-pass/assets/images/wall_image.png" class="img-responsive"></div>
                     </div>
                     <div class="col-md-10">
