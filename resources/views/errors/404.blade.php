...
<div class="container">
	<div class="row">		
		...
		<div id="whoops">
		<img src="{{asset('public/assets/images/404_dark.png')}}" alt="" class="animated swing">
		</div>
			</div>
				</div>
			...
			<p>
			<a href="javascript:history.back()">Go Back</a>, or return to <a href="http://site.startupbug.net:6888/actor-pass/v1/">ActorPass.Com</a> to choose a new page.
			<br/>
