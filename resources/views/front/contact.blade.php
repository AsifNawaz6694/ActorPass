...
<div class="container">
	<div class="row">
		<div class="col-md-6 form">
			...
			<div class="form-area">  
				<form action="{{route('contact_page')}}" method="POST" role="form" id="contact_form">
					{{csrf_field()}}
					<div class="form-group">
						<label>NAME</label>
						<input type="text" class="form-control required fullname" name="name">
					</div>
					<div class="form-group">
						<label>EMAIL</label>
					...
					<div class="form-group">
						<label>MESSAGE</label>
						<textarea class="form-control required" name="user_message" type="textarea" maxlength="140" rows="7"></textarea>						
					</div>
					<div class="button_submit">
						<button type="submit" id="submit" class="btn btn-primary pull-right">SEND MESSAGE
						</button>
					</div>
				</form>
			</div>
